...
describe("Given a RegisterLogin component", () => {
  describe("When the user fills the password field and email, but incorrectly the email, and receives a message modal and press the 'X' button of the modal", () => {
  ...
  describe("When the user fills the password field and email, but incorrectly the password, and receives a message modal and press the 'X' button of the modal", () => {
    test("Then the modal should be closed", async () => {
      const textInput = ["test@test.com", "12345"];
